...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable()
                ...
                .permitAll()
                .antMatchers("/api-market/category/*")
                .permitAll()
                .antMatchers(HttpMethod.POST,"/api-market/user/")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api-market/product/*", "/api-market/product/loadfile/**")
                .permitAll()
                .antMatchers(HttpMethod.POST, "/api-market/person/")
                .permitAll()
                .antMatchers("/api-market/report/*", "/static/diagonal**")
                .permitAll()
